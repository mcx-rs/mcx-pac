...
pub mod bsp32 {
    ...
    impl<const N: u8> Instance<N> {
        ...
        #[inline(always)]
        pub const fn regs(&self) -> BSP32 {
            unsafe { BSP32::from_ptr(self.address() as _) }
        }
        #[inline(always)]
        pub const fn address(&self) -> usize {
            let _ = Self::CHECK;
...
pub mod hpdac {
    ...
    impl<const N: u8> Instance<N> {
        ...
        #[inline(always)]
        pub const fn regs(&self) -> HPDAC {
            unsafe { HPDAC::from_ptr(self.address() as _) }
        }
        #[inline(always)]
        pub const fn address(&self) -> usize {
            let _ = Self::CHECK;
...
pub mod sinc {
    ...
    impl<const N: u8> Instance<N> {
        ...
        #[inline(always)]
        pub const fn regs(&self) -> SINC {
            unsafe { SINC::from_ptr(self.address() as _) }
        }
        #[inline(always)]
        pub const fn address(&self) -> usize {
            let _ = Self::CHECK;
