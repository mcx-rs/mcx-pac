...
pub mod CTRL1 {
    ...
    pub mod OVER_CUR_DIS {
        ...
        pub mod RW {
            ...
            pub const OVRCRNT_DETCT_DIS: u32 = 1;
        }
    }
    #[doc = "OVER_CUR_POL"]
    pub mod OVER_CUR_POL {
        ...
        pub mod RW {
            ...
            pub const ACTIVE_LOW_OVRCRNT: u32 = 1;
        }
    }
    #[doc = "PWR_POL"]
    pub mod PWR_POL {
        ...
        pub mod RW {
            ...
            pub const ACTIVE_HI_PMIC: u32 = 1;
        }
    }
    #[doc = "WIE"]
    pub mod WIE {
...
pub mod CTRL2 {
    ...
    pub mod VBUS_SOURCE_SEL {
        ...
        pub mod RW {
            ...
            #[doc = "sess_valid"]
            pub const SESS_VALID_1: u32 = 1;
            #[doc = "sess_valid"]
            pub const SESS_VALID_2: u32 = 2;
            #[doc = "sess_valid"]
            pub const SESS_VALID_3: u32 = 3;
        }
    }
