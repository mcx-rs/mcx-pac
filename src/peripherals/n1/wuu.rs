...
pub mod regs {
    ...
    impl defmt::Format for DE {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "DE {{ WUDE0: {=bool:?}, WUDE1: {=bool:?}, WUDE2: {=bool:?}, WUDE3: {=bool:?}, WUDE4: {=bool:?}, WUDE5: {=bool:?}, WUDE6: {=bool:?}, WUDE7: {=bool:?}, WUDE8: {=bool:?}, WUDE9: {=bool:?} }}" , self . WUDE0 () , self . WUDE1 () , self . WUDE2 () , self . WUDE3 () , self . WUDE4 () , self . WUDE5 () , self . WUDE6 () , self . WUDE7 () , self . WUDE8 () , self . WUDE9 ())
        }
    }
    ...
    impl defmt::Format for ME {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "ME {{ WUME0: {=bool:?}, WUME1: {=bool:?}, WUME2: {=bool:?}, WUME3: {=bool:?}, WUME4: {=bool:?}, WUME5: {=bool:?}, WUME6: {=bool:?}, WUME7: {=bool:?}, WUME8: {=bool:?}, WUME9: {=bool:?} }}" , self . WUME0 () , self . WUME1 () , self . WUME2 () , self . WUME3 () , self . WUME4 () , self . WUME5 () , self . WUME6 () , self . WUME7 () , self . WUME8 () , self . WUME9 ())
        }
    }
    #[doc = "Parameter"]
    #[repr(transparent)]
    ...
    impl PDC1 {
        ...
        #[inline(always)]
        pub const fn set_WUPDC0(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 0usize)) | (((val as u32) & 0x03) << 0usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPDC1(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 2usize)) | (((val as u32) & 0x03) << 2usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPDC3(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_WUPDC4(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_WUPDC5(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_WUPDC13(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_WUPDC14(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_WUPDC15(&mut self, val: u8) {
    ...
    impl PDC2 {
        ...
        #[inline(always)]
        pub const fn set_WUPDC21(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 10usize)) | (((val as u32) & 0x03) << 10usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for PDC2 {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "PDC2 {{ WUPDC16: {=u8:?}, WUPDC17: {=u8:?}, WUPDC18: {=u8:?}, WUPDC19: {=u8:?}, WUPDC20: {=u8:?}, WUPDC21: {=u8:?}, WUPDC22: {=u8:?}, WUPDC23: {=u8:?}, WUPDC24: {=u8:?}, WUPDC25: {=u8:?}, WUPDC26: {=u8:?}, WUPDC27: {=u8:?}, Reserved28: {=u8:?}, Reserved29: {=u8:?}, Reserved30: {=u8:?}, Reserved31: {=u8:?} }}" , self . WUPDC16 () , self . WUPDC17 () , self . WUPDC18 () , self . WUPDC19 () , self . WUPDC20 () , self . WUPDC21 () , self . WUPDC22 () , self . WUPDC23 () , self . WUPDC24 () , self . WUPDC25 () , self . WUPDC26 () , self . WUPDC27 () , self . Reserved28 () , self . Reserved29 () , self . Reserved30 () , self . Reserved31 ())
        }
    }
    #[doc = "Pin Enable 1"]
    #[repr(transparent)]
    ...
    impl PE1 {
        ...
        #[inline(always)]
        pub const fn set_WUPE0(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 0usize)) | (((val as u32) & 0x03) << 0usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPE1(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 2usize)) | (((val as u32) & 0x03) << 2usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPE3(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 6usize)) | (((val as u32) & 0x03) << 6usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPE4(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 8usize)) | (((val as u32) & 0x03) << 8usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPE5(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 10usize)) | (((val as u32) & 0x03) << 10usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPE13(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 26usize)) | (((val as u32) & 0x03) << 26usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPE14(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 28usize)) | (((val as u32) & 0x03) << 28usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPE15(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 30usize)) | (((val as u32) & 0x03) << 30usize);
        }
    }
    ...
    impl PE2 {
        ...
        #[inline(always)]
        pub const fn set_WUPE21(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 10usize)) | (((val as u32) & 0x03) << 10usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for PE2 {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "PE2 {{ WUPE16: {=u8:?}, WUPE17: {=u8:?}, WUPE18: {=u8:?}, WUPE19: {=u8:?}, WUPE20: {=u8:?}, WUPE21: {=u8:?}, WUPE22: {=u8:?}, WUPE23: {=u8:?}, WUPE24: {=u8:?}, WUPE25: {=u8:?}, WUPE26: {=u8:?}, WUPE27: {=u8:?}, Reserved28: {=u8:?}, Reserved29: {=u8:?}, Reserved30: {=u8:?}, Reserved31: {=u8:?} }}" , self . WUPE16 () , self . WUPE17 () , self . WUPE18 () , self . WUPE19 () , self . WUPE20 () , self . WUPE21 () , self . WUPE22 () , self . WUPE23 () , self . WUPE24 () , self . WUPE25 () , self . WUPE26 () , self . WUPE27 () , self . Reserved28 () , self . Reserved29 () , self . Reserved30 () , self . Reserved31 ())
        }
    }
    #[doc = "Pin Flag"]
    #[repr(transparent)]
    ...
    impl PMC {
        ...
        #[inline(always)]
        pub const fn set_WUPMC0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPMC1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPMC3(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPMC4(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPMC5(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPMC13(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPMC14(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPMC15(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_WUPMC21(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for PMC {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "PMC {{ WUPMC0: {=bool:?}, WUPMC1: {=bool:?}, WUPMC2: {=bool:?}, WUPMC3: {=bool:?}, WUPMC4: {=bool:?}, WUPMC5: {=bool:?}, WUPMC6: {=bool:?}, WUPMC7: {=bool:?}, WUPMC8: {=bool:?}, WUPMC9: {=bool:?}, WUPMC10: {=bool:?}, WUPMC11: {=bool:?}, WUPMC12: {=bool:?}, WUPMC13: {=bool:?}, WUPMC14: {=bool:?}, WUPMC15: {=bool:?}, WUPMC16: {=bool:?}, WUPMC17: {=bool:?}, WUPMC18: {=bool:?}, WUPMC19: {=bool:?}, WUPMC20: {=bool:?}, WUPMC21: {=bool:?}, WUPMC22: {=bool:?}, WUPMC23: {=bool:?}, WUPMC24: {=bool:?}, WUPMC25: {=bool:?}, WUPMC26: {=bool:?}, WUPMC27: {=bool:?}, Reserved28: {=bool:?}, Reserved29: {=bool:?}, Reserved30: {=bool:?}, Reserved31: {=bool:?} }}" , self . WUPMC0 () , self . WUPMC1 () , self . WUPMC2 () , self . WUPMC3 () , self . WUPMC4 () , self . WUPMC5 () , self . WUPMC6 () , self . WUPMC7 () , self . WUPMC8 () , self . WUPMC9 () , self . WUPMC10 () , self . WUPMC11 () , self . WUPMC12 () , self . WUPMC13 () , self . WUPMC14 () , self . WUPMC15 () , self . WUPMC16 () , self . WUPMC17 () , self . WUPMC18 () , self . WUPMC19 () , self . WUPMC20 () , self . WUPMC21 () , self . WUPMC22 () , self . WUPMC23 () , self . WUPMC24 () , self . WUPMC25 () , self . WUPMC26 () , self . WUPMC27 () , self . Reserved28 () , self . Reserved29 () , self . Reserved30 () , self . Reserved31 ())
        }
    }
    #[doc = "Version ID"]
    #[repr(transparent)]
