...
pub mod regs {
    ...
    impl defmt::Format for EICHEN {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = EICHEN {
                EICH8EN: self.EICH8EN(),
                EICH7EN: self.EICH7EN(),
                EICH6EN: self.EICH6EN(),
                EICH5EN: self.EICH5EN(),
