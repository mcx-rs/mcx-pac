...
pub mod regs {
    ...
    impl ATR {
        ...
        #[inline(always)]
        pub fn set_ATSR(&mut self, val: u16) {
        ...
        #[inline(always)]
        pub fn set_ATP(&mut self, val: u16) {
    ...
    impl CR {
        ...
        #[inline(always)]
        pub const fn ATCS0(&self) -> bool {
            let val = (self.0 >> 4usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_ATCS0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        #[inline(always)]
        pub const fn ATCS1(&self) -> bool {
            let val = (self.0 >> 5usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_ATCS1(&mut self, val: bool) {
    ...
    impl defmt::Format for CR {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "CR {{ SWR: {=bool:?}, DEN: {=bool:?}, TFSR: {=bool:?}, UM: {=bool:?}, ATCS0: {=bool:?}, ATCS1: {=bool:?}, DISTAM: {=bool:?}, DPR: {=u16:?} }}" , self . SWR () , self . DEN () , self . TFSR () , self . UM () , self . ATCS0 () , self . ATCS1 () , self . DISTAM () , self . DPR ())
        }
    }
    ...
    impl IER {
        ...
        #[inline(always)]
        pub fn set_TPIE6(&mut self, val: bool) {
        ...
        #[inline(always)]
        pub fn set_TPIE7(&mut self, val: bool) {
    ...
    impl defmt::Format for IER {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "IER {{ DTIE: {=bool:?}, TIIE0: {=bool:?}, TIIE1: {=bool:?}, TIIE2: {=bool:?}, TIIE3: {=bool:?}, TIIE4: {=bool:?}, TIIE5: {=bool:?}, TIIE6: {=bool:?}, TIIE7: {=bool:?}, TIIE8: {=bool:?}, TIIE9: {=bool:?}, TPIE0: {=bool:?}, TPIE1: {=bool:?}, TPIE2: {=bool:?}, TPIE3: {=bool:?}, TPIE4: {=bool:?}, TPIE5: {=bool:?}, TPIE6: {=bool:?}, TPIE7: {=bool:?} }}" , self . DTIE () , self . TIIE0 () , self . TIIE1 () , self . TIIE2 () , self . TIIE3 () , self . TIIE4 () , self . TIIE5 () , self . TIIE6 () , self . TIIE7 () , self . TIIE8 () , self . TIIE9 () , self . TPIE0 () , self . TPIE1 () , self . TPIE2 () , self . TPIE3 () , self . TPIE4 () , self . TPIE5 () , self . TPIE6 () , self . TPIE7 ())
        }
    }
    #[doc = "Lock"]
    #[repr(transparent)]
    ...
    impl LR {
        ...
        #[inline(always)]
        pub const fn PDL(&self) -> bool {
            let val = (self.0 >> 10usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_PDL(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize);
        }
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn ATL0(&self) -> bool {
            let val = (self.0 >> 12usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_ATL0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
        #[inline(always)]
        pub const fn ATL1(&self) -> bool {
            let val = (self.0 >> 13usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_ATL1(&mut self, val: bool) {
        ...
        #[inline(always)]
        pub const fn GFL6(&self) -> bool {
            let val = (self.0 >> 22usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_GFL6(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
        #[inline(always)]
        pub const fn GFL7(&self) -> bool {
            let val = (self.0 >> 23usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_GFL7(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
    }
    impl Default for LR {
    ...
    impl defmt::Format for LR {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "LR {{ CRL: {=bool:?}, SRL: {=bool:?}, LRL: {=bool:?}, IEL: {=bool:?}, TSL: {=bool:?}, TEL: {=bool:?}, PDL: {=bool:?}, PPL: {=bool:?}, ATL0: {=bool:?}, ATL1: {=bool:?}, GFL0: {=bool:?}, GFL1: {=bool:?}, GFL2: {=bool:?}, GFL3: {=bool:?}, GFL4: {=bool:?}, GFL5: {=bool:?}, GFL6: {=bool:?}, GFL7: {=bool:?} }}" , self . CRL () , self . SRL () , self . LRL () , self . IEL () , self . TSL () , self . TEL () , self . PDL () , self . PPL () , self . ATL0 () , self . ATL1 () , self . GFL0 () , self . GFL1 () , self . GFL2 () , self . GFL3 () , self . GFL4 () , self . GFL5 () , self . GFL6 () , self . GFL7 ())
        }
    }
    #[doc = "Pin Direction"]
    #[repr(transparent)]
    ...
    impl PDR {
        #[inline(always)]
        pub const fn TPD0(&self) -> bool {
            let val = (self.0 >> 0usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPD0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[inline(always)]
        pub const fn TPD1(&self) -> bool {
            let val = (self.0 >> 1usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPD1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[inline(always)]
        pub const fn TPD2(&self) -> bool {
            let val = (self.0 >> 2usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPD2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        #[inline(always)]
        pub const fn TPD3(&self) -> bool {
            let val = (self.0 >> 3usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPD3(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        #[inline(always)]
        pub const fn TPD4(&self) -> bool {
            let val = (self.0 >> 4usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPD4(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        #[inline(always)]
        pub const fn TPD5(&self) -> bool {
            let val = (self.0 >> 5usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPD5(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        #[inline(always)]
        pub const fn TPD6(&self) -> bool {
            let val = (self.0 >> 6usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPD6(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        #[inline(always)]
        pub const fn TPD7(&self) -> bool {
            let val = (self.0 >> 7usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPD7(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        #[inline(always)]
        pub const fn TPOD0(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPOD0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[inline(always)]
        pub const fn TPOD1(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPOD1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[inline(always)]
        pub const fn TPOD2(&self) -> bool {
            let val = (self.0 >> 18usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPOD2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize);
        }
        #[inline(always)]
        pub const fn TPOD3(&self) -> bool {
            let val = (self.0 >> 19usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPOD3(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 19usize)) | (((val as u32) & 0x01) << 19usize);
        }
        #[inline(always)]
        pub const fn TPOD4(&self) -> bool {
            let val = (self.0 >> 20usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPOD4(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
        #[inline(always)]
        pub const fn TPOD5(&self) -> bool {
            let val = (self.0 >> 21usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPOD5(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
        #[inline(always)]
        pub const fn TPOD6(&self) -> bool {
            let val = (self.0 >> 22usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPOD6(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
        #[inline(always)]
        pub const fn TPOD7(&self) -> bool {
            let val = (self.0 >> 23usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPOD7(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
    }
    ...
    impl defmt::Format for PDR {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "PDR {{ TPD0: {=bool:?}, TPD1: {=bool:?}, TPD2: {=bool:?}, TPD3: {=bool:?}, TPD4: {=bool:?}, TPD5: {=bool:?}, TPD6: {=bool:?}, TPD7: {=bool:?}, TPOD0: {=bool:?}, TPOD1: {=bool:?}, TPOD2: {=bool:?}, TPOD3: {=bool:?}, TPOD4: {=bool:?}, TPOD5: {=bool:?}, TPOD6: {=bool:?}, TPOD7: {=bool:?} }}" , self . TPD0 () , self . TPD1 () , self . TPD2 () , self . TPD3 () , self . TPD4 () , self . TPD5 () , self . TPD6 () , self . TPD7 () , self . TPOD0 () , self . TPOD1 () , self . TPOD2 () , self . TPOD3 () , self . TPOD4 () , self . TPOD5 () , self . TPOD6 () , self . TPOD7 ())
        }
    }
    ...
    impl PGFR {
        ...
        #[inline(always)]
        pub const fn TPEX(&self) -> u8 {
            let val = (self.0 >> 16usize) & 0x03;
            val as u8
        }
        #[inline(always)]
        pub fn set_TPEX(&mut self, val: u8) {
    ...
    impl defmt::Format for PGFR {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "PGFR {{ GFW: {=u8:?}, GFP: {=bool:?}, GFE: {=bool:?}, TPSW: {=u8:?}, TPSF: {=u8:?}, TPEX: {=u8:?}, TPE: {=bool:?}, TPS: {=bool:?} }}" , self . GFW () , self . GFP () , self . GFE () , self . TPSW () , self . TPSF () , self . TPEX () , self . TPE () , self . TPS ())
        }
    }
    #[doc = "Pin Polarity"]
    #[repr(transparent)]
    ...
    impl PPR {
        ...
        #[inline(always)]
        pub fn set_TPP6(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        #[inline(always)]
        ...
        #[inline(always)]
        pub fn set_TPP7(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn TPID6(&self) -> bool {
            let val = (self.0 >> 22usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPID6(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
        #[inline(always)]
        pub const fn TPID7(&self) -> bool {
            let val = (self.0 >> 23usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub fn set_TPID7(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
    }
    ...
    impl defmt::Format for PPR {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "PPR {{ TPP0: {=bool:?}, TPP1: {=bool:?}, TPP2: {=bool:?}, TPP3: {=bool:?}, TPP4: {=bool:?}, TPP5: {=bool:?}, TPP6: {=bool:?}, TPP7: {=bool:?}, TPID0: {=bool:?}, TPID1: {=bool:?}, TPID2: {=bool:?}, TPID3: {=bool:?}, TPID4: {=bool:?}, TPID5: {=bool:?}, TPID6: {=bool:?}, TPID7: {=bool:?} }}" , self . TPP0 () , self . TPP1 () , self . TPP2 () , self . TPP3 () , self . TPP4 () , self . TPP5 () , self . TPP6 () , self . TPP7 () , self . TPID0 () , self . TPID1 () , self . TPID2 () , self . TPID3 () , self . TPID4 () , self . TPID5 () , self . TPID6 () , self . TPID7 ())
        }
    }
    #[doc = "Status"]
    #[repr(transparent)]
    ...
    impl SR {
        ...
        #[inline(always)]
        pub fn set_TPF6(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
        #[inline(always)]
        ...
        #[inline(always)]
        pub fn set_TPF7(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
    }
    impl Default for SR {
    ...
    impl defmt::Format for SR {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "SR {{ DTF: {=bool:?}, TAF: {=bool:?}, TIF0: {=bool:?}, TIF1: {=bool:?}, TIF2: {=bool:?}, TIF3: {=bool:?}, TIF4: {=bool:?}, TIF5: {=bool:?}, TIF6: {=bool:?}, TIF7: {=bool:?}, TIF8: {=bool:?}, TIF9: {=bool:?}, TPF0: {=bool:?}, TPF1: {=bool:?}, TPF2: {=bool:?}, TPF3: {=bool:?}, TPF4: {=bool:?}, TPF5: {=bool:?}, TPF6: {=bool:?}, TPF7: {=bool:?} }}" , self . DTF () , self . TAF () , self . TIF0 () , self . TIF1 () , self . TIF2 () , self . TIF3 () , self . TIF4 () , self . TIF5 () , self . TIF6 () , self . TIF7 () , self . TIF8 () , self . TIF9 () , self . TPF0 () , self . TPF1 () , self . TPF2 () , self . TPF3 () , self . TPF4 () , self . TPF5 () , self . TPF6 () , self . TPF7 ())
        }
    }
    #[doc = "Tamper Enable"]
    #[repr(transparent)]
    ...
    impl TER {
        ...
        #[inline(always)]
        pub fn set_TPE6(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
        #[inline(always)]
        ...
        #[inline(always)]
        pub fn set_TPE7(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
    }
    ...
    impl defmt::Format for TER {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "TER {{ TIE0: {=bool:?}, TIE1: {=bool:?}, TIE2: {=bool:?}, TIE3: {=bool:?}, TIE4: {=bool:?}, TIE5: {=bool:?}, TIE6: {=bool:?}, TIE7: {=bool:?}, TIE8: {=bool:?}, TIE9: {=bool:?}, TPE0: {=bool:?}, TPE1: {=bool:?}, TPE2: {=bool:?}, TPE3: {=bool:?}, TPE4: {=bool:?}, TPE5: {=bool:?}, TPE6: {=bool:?}, TPE7: {=bool:?} }}" , self . TIE0 () , self . TIE1 () , self . TIE2 () , self . TIE3 () , self . TIE4 () , self . TIE5 () , self . TIE6 () , self . TIE7 () , self . TIE8 () , self . TIE9 () , self . TPE0 () , self . TPE1 () , self . TPE2 () , self . TPE3 () , self . TPE4 () , self . TPE5 () , self . TPE6 () , self . TPE7 ())
        }
    }
}
