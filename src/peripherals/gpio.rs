...
pub struct RegisterBlock {
    ...
    #[doc = "Interrupt Control Register index"]
...
pub mod ICNP {
    ...
    pub mod NPE0 {
        ...
        pub mod W {}
        pub mod RW {
            #[doc = "The pin is configured for Privilege access. Only software in Privilege state can configure a pin to use the corresponding interrupt/trigger output/DMA request or reconfigure a pin that is already configured to use the corresponding interrupt/trigger output/DMA request."]
            pub const NPE0: u32 = 0;
            #[doc = "The pin is configured for Non-Privilege access. Software in either Privilege or Non-Privilege state can configure a pin to use the corresponding interrupt/trigger output/DMA request or reconfigure a pin that is already configured to use the corresponding interrupt/trigger output/DMA request."]
            pub const NPE1: u32 = 1;
        }
    }
    #[doc = "Non-Privilege Enable"]
...
pub mod ICR {
    ...
    pub mod IRQC {
        ...
        pub mod RW {
            ...
            pub const IRQC1: u32 = 1;
            #[doc = "ISF flag and DMA request on falling edge."]
            pub const IRQC2: u32 = 2;
            #[doc = "ISF flag and DMA request on either edge."]
            pub const IRQC3: u32 = 3;
            #[doc = "ISF flag sets on rising edge."]
            pub const IRQC5: u32 = 5;
            #[doc = "ISF flag sets on falling edge."]
            pub const IRQC6: u32 = 6;
            #[doc = "ISF flag sets on either edge."]
            pub const IRQC7: u32 = 7;
            #[doc = "ISF flag and Interrupt when logic 0."]
            pub const IRQC8: u32 = 8;
            #[doc = "ISF flag and Interrupt on rising-edge."]
            pub const IRQC9: u32 = 9;
            #[doc = "ISF flag and Interrupt on falling-edge."]
            pub const IRQC10: u32 = 10;
            #[doc = "ISF flag and Interrupt on either edge."]
            pub const IRQC11: u32 = 11;
            #[doc = "ISF flag and Interrupt when logic 1."]
            pub const IRQC12: u32 = 12;
            #[doc = "Enable active high trigger output, ISF flag on rising edge. Pin state is ORed with other enabled triggers to generate the output trigger, for use by other peripherals."]
            pub const IRQC13: u32 = 13;
            #[doc = "Enable active low trigger output, ISF flag on falling edge. Pin state is inverted and ORed with other enabled triggers to generate the output trigger, for use by other peripherals."]
            pub const IRQC14: u32 = 14;
        }
    }
    ...
    pub mod IRQS {
        ...
        pub mod W {}
        pub mod RW {
            #[doc = "Interrupt/trigger output/DMA request 0."]
            pub const IRQS0: u32 = 0;
            #[doc = "Interrupt/trigger output/DMA request 1."]
            pub const IRQS1: u32 = 1;
        }
    }
    #[doc = "Lock Register"]
    pub mod LK {
