...
pub mod regs {
    ...
    impl CR {
        ...
        #[inline(always)]
        pub fn set_LPOS(&mut self, val: bool) {
    ...
    impl IER {
        ...
        #[inline(always)]
        pub fn set_TIIE(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[inline(always)]
        ...
        #[inline(always)]
        pub fn set_TSIC(&mut self, val: u8) {
    ...
    impl TCR {
        ...
        #[inline(always)]
        pub fn set_TCR(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub fn set_CIR(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub fn set_TCV(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub fn set_CIC(&mut self, val: u8) {
    ...
    impl TPR {
        ...
        #[inline(always)]
        pub fn set_TPR(&mut self, val: u16) {
