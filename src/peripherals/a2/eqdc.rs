...
pub mod regs {
    ...
    impl CTRL {
        ...
        #[inline(always)]
        pub const fn set_LDOK(&mut self, val: bool) {
        ...
        #[inline(always)]
        pub const fn set_WDIRQ(&mut self, val: bool) {
    ...
    impl CTRL2 {
        ...
        #[inline(always)]
        pub const fn set_EMIP(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 11usize)) | (((val as u16) & 0x01) << 11usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl FILT {
        ...
        #[inline(always)]
        pub const fn set_FILT_CS(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 11usize)) | (((val as u16) & 0x01) << 11usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl IMR {
        ...
        #[inline(always)]
        pub const fn set_CMPF0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u16) & 0x01) << 8usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP1F(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u16) & 0x01) << 9usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP2F(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u16) & 0x01) << 10usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP3F(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 11usize)) | (((val as u16) & 0x01) << 11usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl INTCTRL {
        ...
        #[inline(always)]
        pub const fn set_DIRIRQ(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u16) & 0x01) << 3usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP0IE(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u16) & 0x01) << 8usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP0IRQ(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u16) & 0x01) << 9usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP1IE(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u16) & 0x01) << 10usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP1IRQ(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 11usize)) | (((val as u16) & 0x01) << 11usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP2IE(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u16) & 0x01) << 12usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP2IRQ(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u16) & 0x01) << 13usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP3IE(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 14usize)) | (((val as u16) & 0x01) << 14usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_CMP3IRQ(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u16) & 0x01) << 15usize);
        }
    }
