...
pub mod regs {
    ...
    impl AHBMATPRIO {
        ...
        #[inline(always)]
        pub const fn set_CPU1_CBUS_SmartDMA_I(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_CPU1_SBUS_SmartDMA_D(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_PKC_ELS(&mut self, val: u8) {
    ...
    impl DEVICE_ID0 {
        ...
        #[inline(always)]
        pub const fn set_SECURITY(&mut self, val: u8) {
    ...
    impl MSFCFG {
        ...
        #[inline(always)]
        pub const fn set_IFR_ERASE_DIS0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IFR_ERASE_DIS1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IFR_ERASE_DIS2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IFR_ERASE_DIS3(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_MASS_ERASE_DIS(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
    }
    ...
    impl PROTLVL {
        ...
        #[inline(always)]
        pub const fn set_PRIV(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl REMAP {
        ...
        #[inline(always)]
        pub const fn set_SmartDMA_I(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 4usize)) | (((val as u32) & 0x03) << 4usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_SmartDMA_D(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 6usize)) | (((val as u32) & 0x03) << 6usize);
        }
        #[must_use]
        #[inline(always)]
