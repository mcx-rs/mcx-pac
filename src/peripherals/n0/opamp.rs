...
pub mod regs {
    ...
    impl OPAMP_CTR {
        ...
        #[inline(always)]
        pub const fn set_BIASC(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_INTREF(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_INPF(&mut self, val: bool) {
        ...
        #[inline(always)]
        pub const fn set_PREF(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_PGAIN(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_NGAIN(&mut self, val: u8) {
    ...
    impl PARAM {
        ...
        #[inline(always)]
        pub const fn set_PGA_FUNCTION(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
    }
