...
pub mod regs {
    ...
    impl AHBCR {
        ...
        #[inline(always)]
        pub const fn set_RESUMEDISABLE(&mut self, val: bool) {
        ...
        #[inline(always)]
        pub const fn set_ALIGNMENT(&mut self, val: u8) {
    ...
    impl FLSHCR2 {
        ...
        #[inline(always)]
        pub const fn set_AWRWAITUNIT(&mut self, val: u8) {
    ...
    impl HADDRSTART {
        ...
        #[inline(always)]
        pub const fn set_REMAPEN(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl INTEN {
        ...
        #[inline(always)]
        pub const fn set_IPCMDSECUREVIOEN(&mut self, val: bool) {
        ...
        #[inline(always)]
        pub const fn set_AHBGCMERREN(&mut self, val: bool) {
    ...
    impl IPCR2 {
        ...
        #[inline(always)]
        pub const fn set_IPBLKAHBREQ(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IPBLKAHBACK(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IPBLKALLAHB(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
    }
    ...
    impl IPEDCTRL {
        ...
        #[inline(always)]
        pub const fn set_CONFIG(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IPGCMWR(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_AHGCMWR(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_AHBGCMRD(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IPED_PROTECT(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IPED_SWRESET(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize);
        }
    }
    ...
    impl IPEDCTX0START {
        ...
        #[inline(always)]
        pub const fn set_GCM(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_ahbbuserror_dis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl MCR0 {
        ...
        #[inline(always)]
        pub const fn set_RXCLKSRC(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 4usize)) | (((val as u32) & 0x03) << 4usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_SERCLKDIV(&mut self, val: u8) {
    ...
    impl MCR2 {
        ...
        #[inline(always)]
        pub const fn set_RXCLKSRC_B(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_RX_CLK_SRC_DIFF(&mut self, val: bool) {
    ...
    impl STS0 {
        ...
        #[inline(always)]
        pub const fn set_ARBCMDSRC(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 2usize)) | (((val as u32) & 0x03) << 2usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl STS1 {
        ...
        #[inline(always)]
        pub const fn set_AHBCMDERRCODE(&mut self, val: u8) {
            self.0 = (self.0 & !(0x0f << 8usize)) | (((val as u32) & 0x0f) << 8usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_IPCMDERRCODE(&mut self, val: u8) {
