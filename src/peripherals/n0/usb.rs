...
impl USB {
    ...
    pub const fn KEEP_ALIVE_CTRL(
        self,
    ) -> crate::common::Reg<regs::KEEP_ALIVE_CTRL, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0124usize) as _) }
    }
    #[inline(always)]
    pub const fn KEEP_ALIVE_WKCTRL(
        self,
    ) -> crate::common::Reg<regs::KEEP_ALIVE_WKCTRL, crate::common::RW> {
...
pub mod regs {
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct KEEP_ALIVE_CTRL(pub u8);
    ...
    impl core::fmt::Debug for KEEP_ALIVE_CTRL {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("KEEP_ALIVE_CTRL")
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for KEEP_ALIVE_CTRL {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "KEEP_ALIVE_CTRL {{ KEEP_ALIVE_EN: {=bool:?}, OWN_OVERRD_EN: {=bool:?}, STOP_ACK_DLY_EN: {=bool:?}, WAKE_REQ_EN: {=bool:?}, WAKE_INT_EN: {=bool:?}, KEEP_ALIVE_STS: {=bool:?}, WAKE_INT_STS: {=bool:?} }}" , self . KEEP_ALIVE_EN () , self . OWN_OVERRD_EN () , self . STOP_ACK_DLY_EN () , self . WAKE_REQ_EN () , self . WAKE_INT_EN () , self . KEEP_ALIVE_STS () , self . WAKE_INT_STS ())
        }
    }
    #[doc = "Keep Alive Mode Wakeup Control"]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct KEEP_ALIVE_WKCTRL(pub u8);
    ...
    impl core::fmt::Debug for KEEP_ALIVE_WKCTRL {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("KEEP_ALIVE_WKCTRL")
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for KEEP_ALIVE_WKCTRL {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "KEEP_ALIVE_WKCTRL {{ WAKE_ON_THIS: {=u8:?}, WAKE_ENDPT: {=u8:?} }}",
                self.WAKE_ON_THIS(),
                self.WAKE_ENDPT()
            )
        }
