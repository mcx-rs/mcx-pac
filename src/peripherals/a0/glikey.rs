...
pub mod regs {
    ...
    impl defmt::Format for VERSION {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "VERSION {{ Reserved3: {=u8:?}, Reserved7: {=u8:?}, Reserved11: {=u8:?}, Reserved15: {=u8:?}, Reserved16: {=u8:?}, FSM_CONFIG: {=bool:?}, INDEX_CONFIG: {=u8:?}, Reserved31: {=u8:?} }}" , self . Reserved3 () , self . Reserved7 () , self . Reserved11 () , self . Reserved15 () , self . Reserved16 () , self . FSM_CONFIG () , self . INDEX_CONFIG () , self . Reserved31 ())
        }
    }
}
