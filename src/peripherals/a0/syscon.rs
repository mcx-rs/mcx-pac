...
impl SYSCON {
    ...
    #[inline(always)]
    pub const fn OVP_PAD_STATE(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0e40usize) as _) }
    }
    #[inline(always)]
    pub const fn PROBE_STATE(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x0e44usize) as _) }
    }
    #[inline(always)]
    pub const fn FT_STATE_A(self) -> crate::common::Reg<u32, crate::common::RW> {
...
pub mod regs {
    ...
    impl AHBMATPRIO {
        ...
        #[inline(always)]
        pub const fn set_CPU0_CBUS(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_CPU0_SBUS(&mut self, val: u8) {
        ...
        #[inline(always)]
        pub const fn set_USB_FS_ENET(&mut self, val: u8) {
    ...
    impl defmt::Format for CTIMERGLOBALSTARTEN {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "CTIMERGLOBALSTARTEN {{ CTIMER0_CLK_EN: {=bool:?}, CTIMER1_CLK_EN: {=bool:?}, CTIMER2_CLK_EN: {=bool:?} }}" , self . CTIMER0_CLK_EN () , self . CTIMER1_CLK_EN () , self . CTIMER2_CLK_EN ())
        }
    }
    ...
    impl defmt::Format for RAM_CTRL {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "RAM_CTRL {{ RAMA_ECC_ENABLE: {=bool:?}, RAMA_CG_OVERRIDE: {=bool:?}, RAMX_CG_OVERRIDE: {=bool:?} }}" , self . RAMA_ECC_ENABLE () , self . RAMA_CG_OVERRIDE () , self . RAMX_CG_OVERRIDE ())
        }
    }
    ...
    impl REMAP {
        ...
        #[inline(always)]
        pub const fn set_USB0(&mut self, val: u8) {
    ...
    impl defmt::Format for SRAM_XEN {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "SRAM_XEN {{ RAMX0_XEN: {=bool:?}, RAMX1_XEN: {=bool:?}, RAMA0_XEN: {=bool:?}, RAMA1_XEN: {=bool:?}, LOCK: {=bool:?} }}" , self . RAMX0_XEN () , self . RAMX1_XEN () , self . RAMA0_XEN () , self . RAMA1_XEN () , self . LOCK ())
        }
    }
    ...
    impl defmt::Format for SRAM_XEN_DP {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "SRAM_XEN_DP {{ RAMX0_XEN: {=bool:?}, RAMX1_XEN: {=bool:?}, RAMA0_XEN: {=bool:?}, RAMA1_XEN: {=bool:?} }}" , self . RAMX0_XEN () , self . RAMX1_XEN () , self . RAMA0_XEN () , self . RAMA1_XEN ())
        }
    }
}
