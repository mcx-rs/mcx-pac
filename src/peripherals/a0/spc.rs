...
pub mod regs {
    ...
    impl CFG {
        ...
        #[inline(always)]
        pub const fn set_INTG_PWSWTCH_SLEEP_EN(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[inline(always)]
        pub const fn set_INTG_PWSWTCH_WKUP_EN(&mut self, val: bool) {
        ...
        #[inline(always)]
        pub const fn set_INTG_PWSWTCH_SLEEP_ACTIVE_EN(&mut self, val: bool) {
        ...
        #[inline(always)]
        pub const fn set_INTG_PWSWTCH_WKUP_ACTIVE_EN(&mut self, val: bool) {
    ...
    impl defmt::Format for CFG {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "CFG {{ INTG_PWSWTCH_SLEEP_EN: {=bool:?}, INTG_PWSWTCH_WKUP_EN: {=bool:?}, INTG_PWSWTCH_SLEEP_ACTIVE_EN: {=bool:?}, INTG_PWSWTCH_WKUP_ACTIVE_EN: {=bool:?} }}" , self . INTG_PWSWTCH_SLEEP_EN () , self . INTG_PWSWTCH_WKUP_EN () , self . INTG_PWSWTCH_SLEEP_ACTIVE_EN () , self . INTG_PWSWTCH_WKUP_ACTIVE_EN ())
        }
    }
    ...
    impl SC {
        ...
        #[inline(always)]
        pub const fn set_SWITCH_STATE(&mut self, val: bool) {
    ...
    impl defmt::Format for SC {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "SC {{ BUSY: {=bool:?}, SPC_LP_REQ: {=bool:?}, SPC_LP_MODE: {=u8:?}, ISO_CLR: {=bool:?}, SWITCH_STATE: {=bool:?} }}" , self . BUSY () , self . SPC_LP_REQ () , self . SPC_LP_MODE () , self . ISO_CLR () , self . SWITCH_STATE ())
        }
    }
    #[doc = "SRAM Control"]
    #[repr(transparent)]
