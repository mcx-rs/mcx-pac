...
pub mod regs {
    ...
    impl defmt::Format for DTSRCSEL {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "DTSRCSEL {{ SM0SEL45: {=u8:?}, SM0SEL23: {=u8:?}, SM1SEL45: {=u8:?}, SM1SEL23: {=u8:?}, SM2SEL45: {=u8:?}, SM2SEL23: {=u8:?} }}" , self . SM0SEL45 () , self . SM0SEL23 () , self . SM1SEL45 () , self . SM1SEL23 () , self . SM2SEL45 () , self . SM2SEL23 ())
        }
    }
    ...
    impl defmt::Format for SWCOUT {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "SWCOUT {{ SM0OUT45: {=bool:?}, SM0OUT23: {=bool:?}, SM1OUT45: {=bool:?}, SM1OUT23: {=bool:?}, SM2OUT45: {=bool:?}, SM2OUT23: {=bool:?} }}" , self . SM0OUT45 () , self . SM0OUT23 () , self . SM1OUT45 () , self . SM1OUT23 () , self . SM2OUT45 () , self . SM2OUT23 ())
        }
    }
}
